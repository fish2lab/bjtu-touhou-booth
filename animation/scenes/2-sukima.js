...
const S2 = {
  ...
  T: {
    ...
    q: .5, qGap: .38, qPer: .055, qHold: 1.6,   // 引言：起写、每行间隔、每字秒数、写完后停
    og: .6,                        // 镜头到位后原作停
    line: .2, open: .35, hold: .3, close: .3,   // 隙间：划线、张开、停、合上
    lag: .15, card: .3,            // 隙间合上 lag 秒后展签开始翻出；翻出用时
    rows: [0, .2, .35, .45, .55], per: [.03, .018, .015, .03, .03],   // 展签四行（作品名、原作、角色画师、规格、价格）的起写时刻和每字秒数
    priceHold: 2.2, move: .9,      // 价格写完后停；镜头横移
    zoom: .9, wide: .6, gap: .7, dark: 3.35, dim: .25, black: .15,   // 拉远、整面墙停、满屏隙间、深色页、暗下去、墨底交接
  },
  WORKS: [
